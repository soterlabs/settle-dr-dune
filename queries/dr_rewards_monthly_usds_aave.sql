-- =============================================================================
-- DR revenue (MONTHLY) — USDS held in Aave aEthUSDS (Ethereum)
-- =============================================================================
-- Tracks the USDS balance inside the aEthUSDS Aave V3 contract and applies the
-- XR reward rate (same family as USDS-SKY / USDS-SPK).
--
-- No share→USD conversion is needed: USDS is already denominated in USD (1:1).
-- No referral attribution: the entire balance is assigned a single synthetic
-- ref_code 9001 (not an on-chain Referral event code; chosen to avoid collision
-- with all real codes and other synthetic codes in the pipeline).
--
-- Daily balance = end-of-day USDS balance of the aEthUSDS contract address,
-- forward-filled on days with no on-chain activity.
--
...
with
    -- =========================================================================
    -- 1. Signed USDS flow into / out of the aEthUSDS contract
    -- =========================================================================
    raw_events as (
