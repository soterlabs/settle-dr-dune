...
-- DR USDS base. References EXACTLY ONE foundational TWA query (query_7877542) so
...
--
-- usds = daily TWA shares x sUSDS->USDS rate (query_7877548). Ranked by the
