...
--
-- Source: query_7877552 (dr_rewards_monthly_susds_susdc.sql)
...
--
-- Simplified from original design: stUSDS (7877553), farms (7877554), and
-- sp* (7877555) were removed because Dune's stage limit is hit when four
