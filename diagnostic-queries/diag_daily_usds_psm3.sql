...
-- rationale). References EXACTLY ONE foundational TWA query (query_7877543).
--
-- Reports the USDS BASE the DR reward is applied to (NOT the reward):
--   sum_over_users(daily TWA sUSDS shares) x sUSDS->USDS rate (query_7877548).
-- query_7877543 covers base/arbitrum/optimism/unichain; Base is excluded here,
