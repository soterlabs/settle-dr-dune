-- =============================================================================
-- DIAGNOSTIC — spPYUSD deployment-ratio decomposition (query_7877551)
-- -----------------------------------------------------------------------------
...
--
-- This pulls query_7877551's own factors for spPYUSD so we can see WHY the ratio
-- is 0 and whether it's STALE or REAL:
--   * vault_total_supply  : sp* shares outstanding (from query_7877546)
...
--     transfer -> forward-fill overhang / stale vintage (re-run query_7877551 and
--     query_7877546 together to confirm the same vintage).
